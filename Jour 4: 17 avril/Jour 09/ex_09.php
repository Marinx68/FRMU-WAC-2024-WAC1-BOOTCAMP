...
public function moveDown(){
    ...
    final function takeWeapon()
    {
        $this->name. ": take out his weapon.\n";
    }
}
    ...
    function attack()
       {
        ...
        public function moveUp(){
            print $this->name . ": moves up like a bad boy.\n";

        }
        public function moveDown(){
            print $this->name . ": moves down like a bad boy.\n";
...
class Mage extends Character
{
    ...
    public function moveRight(){
        print $this->name . ": moves right with grace.\n";
    }
    public function moveLeft(){
        print $this->name . ": moves left with grace.\n";
    }
    public function moveUp(){
        print $this->name . ": moves up with grace.\n";

    }
    public function moveDown(){
        print $this->name . ": moves down with grace.\n";
